...
def sample_contexts(contexts_dir: Path, words: set[str] | None, per_word: int,
                    seed: int) -> dict[str, list[tuple[str, str]]]:
...
def write_readme(out_dir: Path, summary: list[tuple[str, int]], per_word: int) -> None:
...
def main() -> None:
    ...
    reservoir = sample_contexts(args.contexts, words, args.per_word, args.seed)
